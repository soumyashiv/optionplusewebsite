    ...
    <section>
      <div className="bg-surface-container-lowest border border-outline-variant/30 rounded-xl overflow-hidden shadow-sm">
        ...
        <div className="bg-surface-container-low px-md py-sm flex justify-between items-center border-b border-outline-variant/30">
          ...
          <button 
            onClick={handleAdd}
            className="flex items-center gap-1 text-on-surface-variant hover:text-primary transition-colors justify-center font-medium"
          >
        ...
        <div className="overflow-x-auto">
          {isLoading ? (
            ...
            <div className="p-lg text-center text-on-surface-variant">Your watchlist is empty. Click 'Add' to add instruments.</div>
          ) : (
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-outline-variant/10">
                {items.map((item) => {
                  ...
                  // null ltp + no oi_label → strike is outside ATM±5 analysis window
                    ...
                    <tr key={item.id} className="hover:bg-surface-variant/20 transition-colors">
                      ...
                      <td className="px-md py-sm text-right">
                        <button 
                          ...
                          className="text-on-surface-variant hover:text-red-500 transition-colors inline-flex p-1 rounded hover:bg-surface-variant"
